...
// Ambil data transaksi stock out
$stmt = $pdo->prepare("
    SELECT 
        so.*, 
        p.product_name, 
...
<head>
    ...
    <title>Nota Transaksi Stock Out #<?= $data['id'] ?></title>
...
<div class="container">
    <div class="receipt-card">
        ...
        <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom">
            ...
            <div class="text-end">
                <span class="badge bg-danger px-3 py-2">STOCK OUT</span>
                <div class="small text-muted mt-1">#TRX-OUT-<?= str_pad((string)$data['id'], 5, '0', STR_PAD_LEFT) ?></div>
            </div>
        </div>
        ...
        <div class="row text-center mt-5 pt-3 small">
            <div class="col-6">
                <p class="mb-5">Petugas Penyerah,</p>
                <p class="fw-bold mb-0">( Administrator )</p>
            </div>
            <div class="col-6">
                <p class="mb-5">Penerima / Pemohon,</p>
