...
if (!$data) {
    die("Data Tax Invoice External tidak ditemukan.");
}

$items = getTransactionItems($pdo, $transactionId);

if (count($items) === 0) {
    die("Data produk untuk Tax Invoice External ini tidak ditemukan.");
}

// ================================
// Nomor Tax Invoice External
// ================================
$external_number = $tax_number = generateTaxExternalNumber($transactionId);
...
<tr>
    <td>Invoice</td>
    <td><?= htmlspecialchars($external_number) ?></td>
</tr>
