<?php
// Panggil file helper
require_once __DIR__ . '/tax_internal_helper.php';
...
if (!$data) {
    die("Data Tax Invoice Internal tidak ditemukan.");
}

$items = getTransactionItems($pdo, $transactionId);

if (count($items) === 0) {
    die("Data produk untuk Tax Invoice Internal ini tidak ditemukan.");
}

// ================================
// Nomor Tax Invoice Internal
// ================================
$tax_number = 'TII-' . date('Ymd') . '-' . str_pad((string)$data['id'], 6, '0', STR_PAD_LEFT);
    ...
    <td style="width:50%; vertical-align:top; padding-left:8px;">
        <div class="p-3 bg-light rounded-3 border shadow-sm">
            ...
            <table class="table table-sm table-borderless mb-0">
                ...
                <tr>
                    <td>PKP</td>
                    <td>: PT Karunia Medika Sejahtera</td>
                </tr>
