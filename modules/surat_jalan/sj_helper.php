...
| CATATAN
|--------------------------------------------------------------------------
| Fungsi getSuratJalan() (dulu pakai LIMIT 1, jadi cuma ambil 1 produk)
 ...
 * Nomor Surat Jalan
 */
function generateSJNumber(int $id): string
{
    return 'SJ-' . date('Ymd') . '-' . str_pad((string)$id, 6, '0', STR_PAD_LEFT);
}
