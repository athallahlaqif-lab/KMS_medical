...
// Panggil file helper
require_once __DIR__ . '/sj_helper.php';
...
$sj_number = generateSJNumber($transactionId);
...
if (count($items) === 0) {
    die("Data produk untuk Surat Jalan ini tidak ditemukan.");
}
...
<head>
    ...
    <title>Surat Jalan - <?= htmlspecialchars($sj_number) ?></title>
...
<div class="watermark">
    ...
    <script>
        window.onload = function () {
            document.title = "Surat Jalan - <?= $sj_number ?>";
        };
    </script>
